<%@page import="com.cy.pj.sys.util.MTimeUtil"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="java.util.*"%>
<%@ page import="com.cy.pj.sys.entity.*" %>
						...
						<form method="post" class="form-horizontal" id="commentForm" action="<%=path %>/employee/<%=employee.getId() %>/update.do">
							...
							<div class="form-group">
								<div class="col-sm-4 col-sm-offset-8">
								    <input type="hidden" class="form-control" name="status" value="在职">
								    <input type="hidden" class="form-control" name="departmentNumber" value="<%=employee.getDepartmentNumber() %>">
